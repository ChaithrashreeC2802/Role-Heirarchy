...
# At first it will ask to choose the root role name. Then it will give 10 options to the user like 
  ...
  # 4. Add User 
  # 5. Display Users  
  # 6. Display Users and Sube 
  # 7. Delete User 
  # 8. Number of users from top 
  # 9. Height of role hierarchy 
  # 10. Common boss of users The user has to choose a option between 1 to 10. 
...
# Delete Role: This option allows the user to delete a role and transform that deleted role to another role.
# Add User: By using this the user can provide a user name to the roles.
...
# Height of role hierarchy: It will give the height of the heirarchy. 10.Common boss of users: It will ask for 2 user name and provide the common user of both the users.
